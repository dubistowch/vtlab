...
export default (props) => {
  ...
  const {
    photoURL: currentPhoroURL = '', displayName: currentDisplayName = '', email = '', notificationsDisabled = false,
  } = auth || {}
  ...
  const hasChange = displayName !== currentDisplayName || photoURL !== currentPhoroURL
  ...
  const openDeleteDialog = () => {
    openDialog({
      ...
      message: intl.formatMessage({
        ...
        defaultMessage: 'This Account and all related data to it will be deleted permanently. Do you want to proceed with the deletion?',
      }),
  ...
  const openReauthenticateDialog = () => {
    openDialog({
      ...
      message: intl.formatMessage({
        ...
        defaultMessage: 'To ensure that you are the real owner of this account a reauthentication is required. For that you need to logout and login into the application. By pressing the REAUTHENTICATION button you will be logged out automaticaly. After you login afain you can delete your account!',
      }),
      action: intl.formatMessage({
